        ...
        for t_i in range(config.episode_length):
            ...
            if t_i == config.episode_length - 1 or all(dones):
                ...
                print('Episode:', ep_i, '\t|\t', 'Reward:', total_r[-1],
                      'data_rate:', env.world.data_rate, 'energy:', env.world.energy,
...
def save_plot():  # 保存数据&画图
    # 将每一回合的reward存为csv文件
    file_name1 = 'E:/research/orientation/code/maddpg-pytorch-master/results_matd3/reward_e.csv'
    # save_data(file_name1, total_r)

    # 存储最后一回合的无人机轨迹
    file_name2 = 'E:/research/orientation/code/maddpg-pytorch-master/results_matd3/UAV_path.csv'
    save_data(file_name2, UAV_pos)

    # 存储最后一回合的地面设备位置坐标
    file_name3 = 'E:/research/orientation/code/maddpg-pytorch-master/results_matd3/UE_pos.csv'
...
if __name__ == '__main__':
    ...
    parser.add_argument("--model_name",
                        default="E:/research/orientation/code/maddpg-pytorch-master/model_matd3/path_aoi_e",
                        help="Name of model")
    parser.add_argument("--run_num", default=8, type=int)
