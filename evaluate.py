...
def save_plot():  # 保存数据&画图
    # 将每一回合的reward存为csv文件
    file_name1 = 'E:/lu/orientation/code/maddpg-pytorch-master/results/reward_e.csv'
    # save_data(file_name1, total_r)

    # 存储最后一回合的无人机轨迹
    file_name2 = 'E:/lu/orientation/code/maddpg-pytorch-master/results/UAV_path.csv'
    save_data(file_name2, UAV_pos)

    # 存储最后一回合的地面设备位置坐标
    file_name3 = 'E:/lu/orientation/code/maddpg-pytorch-master/results/UE_pos.csv'
...
if __name__ == '__main__':
    ...
    parser.add_argument("--env_id", default="UAV_path_u", help="Name of environment")
