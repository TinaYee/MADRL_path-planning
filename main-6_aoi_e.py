...
def save_plot():  # 保存数据&画图
    # 将每一回合的reward存为csv文件
    file_name1 = 'E:/lu/orientation/code/maddpg-pytorch-master/results/aoi_e/reward_6.csv'
...
if __name__ == '__main__':
    ...
    parser.add_argument("--n_episodes", default=30000, type=int)  # 25000
    ...
    parser.add_argument("--lr_c", default=1e-3, type=float)  # critic 的学习率要更大一些 1-10倍
    ...
    # 高斯噪声标准差
    parser.add_argument("--noise_std_init", type=float, default=0.4, help="The std of Gaussian noise for exploration")
    parser.add_argument("--noise_std_min", type=float, default=0.0, help="The std of Gaussian noise for exploration")
    parser.add_argument("--noise_decay_steps", type=float, default=20000,
